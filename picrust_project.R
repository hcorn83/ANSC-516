...
metadata <- rename(metadata, "ID" = "SampleID")
...
diagdds = phyloseq_to_deseq2(physeq_picrust, ~ State)
...
alpha = 0.05
#my_contrast = c("State", "A", "B") 
#my_contrast = c("State", "A", "C") 
...
str(sigtab)
setwd("~/Documents/ANSC516/Putty/moving-pictures-picrust2")
...
ggsave(paste0("output/DESeq2-", my_contrast[2], "-", my_contrast[3], ".png"), DESeq_fig, height = 8, width = 3)
